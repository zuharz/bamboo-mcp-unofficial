 ...
 */
export function formatTimeOffRequests(
  requests: BambooTimeOffRequest[],
  startDate: string,
  endDate: string
): string {
 ...
 */
export function formatDatasetsList(datasets: BambooDataset[]): string {
 ...
 */
export function formatFieldAnalysis(
  records: BambooDatasetRecord[],
  fieldName: string,
  displayName: string,
 ...
 */
export function formatWorkforceAnalytics(
  records: BambooDatasetRecord[],
  datasetId: string,
  requestedFields: string[]
): string {
