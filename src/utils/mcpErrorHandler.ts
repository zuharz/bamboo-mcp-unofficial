 ...
 */
export function validateRequestId(requestId: string | null | undefined): void {
    ...
    switch (statusCode) {
      case 400:
        ...
        troubleshooting.push(
          'Check your request parameters for correct format'
        );
        break;
      case 401:
        code = MCP_ERROR_CODES.AUTHENTICATION_REQUIRED;
      ...
      case 403:
        code = MCP_ERROR_CODES.UNAUTHORIZED;
        troubleshooting.push(
          'Your API key may lack permissions for this resource'
        );
        troubleshooting.push(
          'Some features require specific BambooHR subscription levels'
        );
        break;
      case 404:
        code = MCP_ERROR_CODES.RESOURCE_NOT_FOUND;
 ...
 */
export function clearProcessedRequestIds(): void {
